...
def main():
    ...
    if mode == 'pair':
        # cut training data
        GT_folder = '/home/zhao/dc/datasets/DIV2K/HR'# fix to your path
        LR_folder = '/home/zhao/dc/datasets/DIV2K/LR/X4'# fix to your path
        save_GT_folder = '/home/zhao/dc/datasets/DIV2K/HR_patch'
        save_LR_folder = '/home/zhao/dc/datasets/DIV2K/LR_patch/X4'

        scale_ratio = 4
        crop_sz = 240  # the size of each sub-image (GT)
        step = 120  # step of the sliding crop window (GT)
