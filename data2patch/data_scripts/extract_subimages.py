...
# sys.path.append("/home/zhao/dc/code/CAMixerSR-main/codes/basicsr")
sys.path.append("/home/zhao/dc/code/code_base/basicsr")
print(sys.path)
...
def main():
    ...
    # HR images
    # opt['input_folder'] = '/home/zhao/dc/datasets/DIV2K/HR'
    # opt['save_folder'] = '/home/zhao/dc/datasets/DIV2K/HR_patch'
    opt['input_folder'] = '/home/zhao/dc/datasets/DIV2K/HR'
    opt['save_folder'] = '/home/zhao/dc/datasets/DIV2K/HR_patch'
    opt['crop_size'] = 480
    opt['step'] = 240
    ...
    # LRx4 images
    opt['input_folder'] = '/home/zhao/dc/datasets/DIV2K/LR/X4'
    opt['save_folder'] = '/home/zhao/dc/datasets/DIV2K/LR_patch/X4'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
