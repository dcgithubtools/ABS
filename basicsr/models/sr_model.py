...
class SRModel(BaseModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        # if self.cri_grad:
        #     self.output_g = self.get_grad(self.output)
        #     self.gt_g = self.get_grad(self.gt)

        #     l_pix_grad = 0.02 * self.cri_grad(self.output_g, self.gt_g)

        #     l_total += l_pix_grad

        #     loss_dict['l_pix_grad'] = l_pix_grad
